...
public class CleanlinessBar : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string sqlQuery = "SELECT cleanliness " + "FROM condition " + "WHERE Id=1";
        Debug.Log(sqlQuery);
    ...
    void Update()
    {
        ...
        if (save >= 5000)
        {
            ...
            string sqlQuery = "UPDATE condition set cleanliness = " + new_value + " WHERE Id=1";
            Debug.Log(sqlQuery);
            dbcmd.CommandText = sqlQuery;
